        ...
        <div className="list-elem font">
            <div className="elem-block">
                ...
                <div className="buttons">
                    ...
                    <button className={!props.todoo.done ? 'btn btn-success' : 'btn btn-warning'} onClick={!props.todoo.done ? () => props.editDone(props.todoo, true) : () => props.editDone(props.todoo, false)}>{!props.todoo.done ? "Confirm" : "Decline"}</button>
